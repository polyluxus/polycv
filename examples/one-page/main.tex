...
% \polycvheaderheight{5cm}  % Default: 4.0 cm
% \polycvfooterheight{2cm}  % Default: 0.5 cm
% \polycvmargins{0.8cm}     % Default: 1.0 cm
\polycvhintcolumnwidth{3cm} % Default: 2.7 cm
% \polycvhintcolumnsep{1cm} % Default: 0.2 cm
\polycviconspace{0.6cm}     % Default: 0.8 cm
% \polycventryraggedright   % Default: justified
